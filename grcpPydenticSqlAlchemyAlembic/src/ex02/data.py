...
ARMED = [True, False]
RANK = ["Commander", "Teacher", "Student"]
FIRST_NAMES = ["Scott", "Mackenzie", "Matthew", "Carly", "Tiffany"]
LAST_NAMES = ["Norris", "Hernandez", "Miller", "Hernandez", "Larson"]
...
class Data:
    ...
    def generate_data(self):
        ...
        for _ in range(random.randint(START, END)):
            ...
            item.first_name = random.choice(FIRST_NAMES)
            item.last_name = random.choice(LAST_NAMES)
...
if __name__ == "__main__":
    print("[", end="")
    for _ in range(10):
        print(f"'{Faker().name().split(' ')[1]}', ", end="")
    print("]")
